...
lst = get_png_images_from_folder('ProcessingQueue\\Witches - Training Ritual')
for i in lst:
    print(i)
...
def convert_images_to_pdf_and_merge(modified_png_lst, filename):
    ...
    output_directory = 'Transformed\\Translated'
